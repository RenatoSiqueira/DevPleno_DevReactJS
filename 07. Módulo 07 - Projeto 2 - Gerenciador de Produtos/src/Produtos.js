            ...
            <div className='row'>
                ...
                <div className='col-md-10'>
                    ...
                    <Route
                        ...
                        render={(props) => {
                            return <Categoria {...props} loadProdutos={this.props.loadProdutos} loadCategoria={this.props.loadCategoria} categoria={this.props.categoria} produtos={this.props.produtos} />
                        }}
                    />
                </div>
            </div>
